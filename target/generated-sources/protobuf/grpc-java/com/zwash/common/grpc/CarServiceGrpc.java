...
public final class CarServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "com.zwash.common.grpc.CarService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.zwash.common.grpc.CarRequest,
      com.zwash.common.grpc.CarResponse> getGetCarMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetCar",
      requestType = com.zwash.common.grpc.CarRequest.class,
      responseType = com.zwash.common.grpc.CarResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.zwash.common.grpc.CarRequest,
      com.zwash.common.grpc.CarResponse> getGetCarMethod() {
    io.grpc.MethodDescriptor<com.zwash.common.grpc.CarRequest, com.zwash.common.grpc.CarResponse> getGetCarMethod;
      ...
      synchronized (CarServiceGrpc.class) {
        if ((getGetCarMethod = CarServiceGrpc.getGetCarMethod) == null) {
          CarServiceGrpc.getGetCarMethod = getGetCarMethod =
              io.grpc.MethodDescriptor.<com.zwash.common.grpc.CarRequest, com.zwash.common.grpc.CarResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetCar"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zwash.common.grpc.CarRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.zwash.common.grpc.CarResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getCar(com.zwash.common.grpc.CarRequest request,
        io.grpc.stub.StreamObserver<com.zwash.common.grpc.CarResponse> responseObserver) {
  ...
  public static final class CarServiceStub
    ...
    /**
     */
    public void getCar(com.zwash.common.grpc.CarRequest request,
        io.grpc.stub.StreamObserver<com.zwash.common.grpc.CarResponse> responseObserver) {
  ...
  public static final class CarServiceBlockingStub
    ...
    /**
     */
    public com.zwash.common.grpc.CarResponse getCar(com.zwash.common.grpc.CarRequest request) {
  ...
  public static final class CarServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.zwash.common.grpc.CarResponse> getCar(
        com.zwash.common.grpc.CarRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CAR:
          serviceImpl.getCar((com.zwash.common.grpc.CarRequest) request,
              (io.grpc.stub.StreamObserver<com.zwash.common.grpc.CarResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.zwash.common.grpc.CarRequest,
              com.zwash.common.grpc.CarResponse>(
